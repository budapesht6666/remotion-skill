 ...
 * четыре кадра на выбеливание (это меньше одной шестой секунды), затем белое
...
export const FlashScene: React.FC = () => {
  ...
  const white = interpolate(frame, [0, 4], [0, 1], { extrapolateRight: "clamp" });
  ...
  const ringOpacity = interpolate(frame, [2, 8, 30], [0, 0.9, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
